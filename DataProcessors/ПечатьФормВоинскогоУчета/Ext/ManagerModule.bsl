...
Процедура Печать(МассивОбъектов, ПараметрыПечати, КоллекцияПечатныхФорм, ОбъектыПечати, ПараметрыВывода) Экспорт
	...
	Если УправлениеПечатью.НужноПечататьМакет(КоллекцияПечатныхФорм, "ПФ_MXL_ПриказОбОрганизацииВоинскогоУчета") Тогда
		УправлениеПечатью.ВывестиТабличныйДокументВКоллекцию(
						...
						"ПФ_MXL_ПриказОбОрганизацииВоинскогоУчета", НСтр("ru='Приказ об организации воинского учета';uk='Наказ про організацію військового обліку'"),
	...
	Если УправлениеПечатью.НужноПечататьМакет(КоллекцияПечатныхФорм, "ПФ_MXL_ПланРаботыПоОсуществлениюВоинскогоУчета") Тогда 
		УправлениеПечатью.ВывестиТабличныйДокументВКоллекцию(
						КоллекцияПечатныхФорм,
						"ПФ_MXL_ПланРаботыПоОсуществлениюВоинскогоУчета", НСтр("ru='План работы по осуществлению воинского учета';uk='План роботи по здійсненню військового обліку'"),
