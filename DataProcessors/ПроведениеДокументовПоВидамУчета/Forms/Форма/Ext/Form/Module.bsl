...
Процедура ПровестиДокументы(Команда)
	...
	Если Не ЗначениеЗаполнено(Объект.Период) Тогда
		ОбщегоНазначенияКлиент.СообщитьПользователю(НСтр("ru='Не заполнен период';uk='Не заповнений період'"));
		Возврат;
	КонецЕсли;
	
	Если Не ЗначениеЗаполнено(ВидыУчетов) Тогда
		ОбщегоНазначенияКлиент.СообщитьПользователю(НСтр("ru='Не заполнены виды учетов';uk='Не заповнені види обліків'"));
		Возврат;
	КонецЕсли;
