...
Процедура Присоединить(Команда)
	...
	ТекстВопроса = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(НСтр("ru='Выбранные файлы будут присоединены к работнику %1.';uk='Вибрані файли будуть приєднані до працівника %1.'"), ФизическоеЛицо);
...
Процедура ВосстановитьДанныеФайлов()
	...
	Для Каждого ИдентификаторСтроки Из Элементы.Файлы.ВыделенныеСтроки Цикл
		...
		Исключение
			...
			ТекстОшибки = НСтр("ru='Ошибка при восстановлении файла %1';uk='Помилка при відновленні файлу %1'");
