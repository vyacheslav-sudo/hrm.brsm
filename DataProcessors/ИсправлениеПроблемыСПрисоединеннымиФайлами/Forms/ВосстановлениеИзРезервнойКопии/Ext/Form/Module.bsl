...
Процедура ВосстановитьДанныеФайлов(Отказ)
	...
	Исключение
		...
		ТекстОшибки = НСтр("ru='Ошибка создания COM-объекта: %1. Обратитесь к администратору информационной системы.';uk='Помилка створення COM-об''єкта: %1. Зверніться до адміністратора інформаційної системи.'");
	...
	Исключение
		...
		ТекстОшибки = НСтр("ru='Не удалось подключиться к информационной базе:';uk='Не вдалося підключитися до інформаційної бази:'");
