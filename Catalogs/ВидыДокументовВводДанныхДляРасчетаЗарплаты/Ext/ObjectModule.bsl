...
Процедура ОбработкаПроверкиЗаполнения(Отказ, ПроверяемыеРеквизиты)
	...
	Пока Выборка.СледующийПоЗначениюПоля("ВидОшибки") Цикл
		...
		Если Выборка.ВидОшибки = "Показатели" Тогда
			ТекстОшибки = ТекстОшибки + НСтр("ru='используются удаляемые показатели:';uk='використовуються показники, що вилучаються:'");
			ПолеОшибки = "Показатели";
		ИначеЕсли Выборка.ВидОшибки = "ВидыВремени" Тогда
			ТекстОшибки = ТекстОшибки + НСтр("ru='используются удаляемые виды времени:';uk='використовуються види часу, що вилучаються:'");
			ПолеОшибки = "ВидыРабочегоВремени";
		ИначеЕсли Выборка.ВидОшибки = "ВидыРабот" Тогда
			ТекстОшибки = ТекстОшибки + НСтр("ru='используются удаляемые работы:';uk='використовуються роботи, що вилучаються:'");
