...
Процедура УстановитьДоступностьЭлементов()
	...
	ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(Элементы, "ВоинскийУчетПроходитВоеннуюСлужбу", "Видимость", НЕ Призывник);
...
Процедура ЗаполнитьЗначенияПоУмолчанию()
	...
	Если ВоинскийУчет.ОтношениеКВоинскойОбязанности = Перечисления.ОтношениеКВоинскойОбязанности.Призывник Тогда
		...
		ВоинскийУчет.ПроходитВоеннуюСлужбу = ЛОЖЬ;
	КонецЕсли;	
