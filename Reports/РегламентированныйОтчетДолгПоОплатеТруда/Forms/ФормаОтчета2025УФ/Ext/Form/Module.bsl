...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	СтруктураРеквизитовФормы.мСоставПоказателей = "СоставПоказателей2025";
...
Процедура ЗаполнитьСведенияОбОрганизации(Форма, ИзмененаДатаПодписи = Ложь)
	...
	ЗаполнитьПоказательНаСервере("FIRM_NAME", Организация.НаименованиеПолное, Форма, "ДолгПоОплате");
	...
	КонецЕсли;
	ЗаполнитьПоказательНаСервере("FIRM_ZIP",    Индекс,    Форма, "ДолгПоОплате");
	ЗаполнитьПоказательНаСервере("FIRM_CITY",   Город,     Форма, "ДолгПоОплате");
	ЗаполнитьПоказательНаСервере("FIRM_OBL",    Область,   Форма, "ДолгПоОплате");
	ЗаполнитьПоказательНаСервере("FIRM_STREET", Улица,     Форма, "ДолгПоОплате");
	ЗаполнитьПоказательНаСервере("FIRM_DOM1",   НомерДома, Форма, "ДолгПоОплате");
	ЗаполнитьПоказательНаСервере("FIRM_KORPUS", Корпус,    Форма, "ДолгПоОплате");
	ЗаполнитьПоказательНаСервере("FIRM_KVART",  Офис,      Форма, "ДолгПоОплате");
	ЗаполнитьПоказательНаСервере("FIRM_RAYON",  Район,     Форма, "ДолгПоОплате");
	ЗаполнитьПоказательНаСервере("FIRM_TERGROM", "",       Форма, "ДолгПоОплате");
	ЗаполнитьПоказательНаСервере("FIRM_RAYGOR",  "",       Форма, "ДолгПоОплате");
	...
	ЗаполнитьПоказательНаСервере("ZIP_FACT",    Индекс,  Форма, "ДолгПоОплате");
	ЗаполнитьПоказательНаСервере("CITY_FACT",   Город,   Форма, "ДолгПоОплате");
	ЗаполнитьПоказательНаСервере("OBL_FACT",    Область, Форма, "ДолгПоОплате");
	ЗаполнитьПоказательНаСервере("STREET_FACT", Улица,   Форма, "ДолгПоОплате");
	ЗаполнитьПоказательНаСервере("DOM1_FACT",   НомерДома, Форма, "ДолгПоОплате");
	ЗаполнитьПоказательНаСервере("KORPUS_FACT", Корпус,  Форма, "ДолгПоОплате");
	ЗаполнитьПоказательНаСервере("KVART_FACT",  Офис,    Форма, "ДолгПоОплате");
	ЗаполнитьПоказательНаСервере("RAYON_FACT",  Район,   Форма, "ДолгПоОплате");
	ЗаполнитьПоказательНаСервере("TERGROM_FACT", "",       Форма, "ДолгПоОплате");
	ЗаполнитьПоказательНаСервере("RAYGOR_FACT",  "",       Форма, "ДолгПоОплате");
...
Функция ПолучитьДанныеФормыНаСервере();
	...
	//2024
	КодКАТОТТГ = ПолучитьПоказательНаСервере("КАТОТТГ", ЭтаФорма, "ДолгПоОплате");
