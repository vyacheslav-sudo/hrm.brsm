...
Функция ТаблицаФормОтчета() Экспорт
	...
	НоваяФорма.ОписаниеОтчета     = НСтр("ru='Утверждена Приказом Госкомстата Украины от 15.04.2024 № 115';uk= 'Затверджена наказом Держкомстату України від 15.04.2024 № 115'");
