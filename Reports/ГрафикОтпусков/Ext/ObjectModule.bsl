...
Процедура ВывестиМакет(ДокументРезультат, Данные)
	...
	Для Каждого ДанныеПоОрганизации Из Данные.Строки Цикл
		...
		Для Каждого ДанныеПоГоду Из ДанныеПоОрганизации.Строки Цикл
			...
			ОбластьШапка.Параметры.ОрганизацияНаименование = ВРег(Сокрлп(?(ЗначениеЗаполнено(СокрЛП(ДанныеПоГоду.Организация.НаименованиеПолное)), ДанныеПоГоду.Организация.НаименованиеПолное, ДанныеПоГоду.Организация.Наименование)));
