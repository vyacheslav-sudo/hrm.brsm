...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	СтруктураРеквизитовФормы.мСоставПоказателей = "СоставПоказателей2025Мес";
...
Процедура ЗаполнитьСведенияОбОрганизации(Форма, ИзмененаДатаПодписи = Ложь)
	...
	ЗаполнитьПоказательНаСервере("FIRM_NAME", Организация.НаименованиеПолное, Форма, "ОтчетПоТрудуМес");
	...
	ПериодОтчета = Формат(Форма.СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета, "ДФ = 'ММММ гггг';Л = uk_UA");
	...
	ЗаполнитьПоказательНаСервере("REP_PERNM", ПериодОтчета, Форма, "ОтчетПоТрудуМес");
	...
	КонецЕсли;
	ЗаполнитьПоказательНаСервере("FIRM_ZIP",    Индекс,    Форма, "ОтчетПоТрудуМес");
	ЗаполнитьПоказательНаСервере("FIRM_CITY",   Город,     Форма, "ОтчетПоТрудуМес");
	ЗаполнитьПоказательНаСервере("FIRM_OBL",    Область,   Форма, "ОтчетПоТрудуМес");
	ЗаполнитьПоказательНаСервере("FIRM_STREET", Улица,     Форма, "ОтчетПоТрудуМес");
	ЗаполнитьПоказательНаСервере("FIRM_DOM1",   НомерДома, Форма, "ОтчетПоТрудуМес");
	ЗаполнитьПоказательНаСервере("FIRM_KORPUS", Корпус,    Форма, "ОтчетПоТрудуМес");
	ЗаполнитьПоказательНаСервере("FIRM_KVART",  Офис,      Форма, "ОтчетПоТрудуМес");
	ЗаполнитьПоказательНаСервере("FIRM_RAYON",  Район,     Форма, "ОтчетПоТрудуМес");
	ЗаполнитьПоказательНаСервере("FIRM_TERGROM", "",       Форма, "ОтчетПоТрудуМес");
	ЗаполнитьПоказательНаСервере("FIRM_RAYGOR",  "",       Форма, "ОтчетПоТрудуМес");
	...
	ЗаполнитьПоказательНаСервере("ZIP_FACT",    Индекс,  Форма, "ОтчетПоТрудуМес");
	ЗаполнитьПоказательНаСервере("CITY_FACT",   Город,   Форма, "ОтчетПоТрудуМес");
	ЗаполнитьПоказательНаСервере("OBL_FACT",    Область, Форма, "ОтчетПоТрудуМес");
	ЗаполнитьПоказательНаСервере("STREET_FACT", Улица,   Форма, "ОтчетПоТрудуМес");
	ЗаполнитьПоказательНаСервере("DOM1_FACT",   НомерДома, Форма, "ОтчетПоТрудуМес");
	ЗаполнитьПоказательНаСервере("KORPUS_FACT", Корпус,  Форма, "ОтчетПоТрудуМес");
	ЗаполнитьПоказательНаСервере("KVART_FACT",  Офис,    Форма, "ОтчетПоТрудуМес");
	ЗаполнитьПоказательНаСервере("RAYON_FACT",  Район,   Форма, "ОтчетПоТрудуМес");
	ЗаполнитьПоказательНаСервере("TERGROM_FACT", "",       Форма, "ОтчетПоТрудуМес");
	ЗаполнитьПоказательНаСервере("RAYGOR_FACT",  "",       Форма, "ОтчетПоТрудуМес");
...
Процедура Заполнить(ПараметрыЗаполненияЗвит1С)
	...
	Если ЗарплатаКадрыРасширенная Тогда
		...
		МассивВидыВремениРабота.Добавить(Справочники.ВидыИспользованияРабочегоВремени.Командировка);
		МассивВидыВремениРабота.Добавить(Справочники.ВидыИспользованияРабочегоВремени.Праздники);
		МассивВидыВремениРабота.Добавить(Справочники.ВидыИспользованияРабочегоВремени.Сверхурочные);
		МассивВидыВремениРабота.Добавить(Справочники.ВидыИспользованияРабочегоВремени.СокращенноеРабочееВремя);
		...
		|ИЗ
		|	ВТДанныеУчетаВремениИСостоянийСотрудников КАК ДанныеУчетаВремениПоСостояниям
...
Функция ПолучитьДанныеФормыНаСервере();
	...
	//2024
	КодКАТОТТГ = ПолучитьПоказательНаСервере("КАТОТТГ", ЭтаФорма, "ОтчетПоТрудуМес");
