...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	РасчетЧисленностиКакВ1ПВ = Параметры.РасчетЧисленностиКакВ1ПВ;
	...
	СтруктураПараметров.Вставить("РасчетЧисленностиКакВ1ПВ", РасчетЧисленностиКакВ1ПВ);
...
Процедура УправлениеЭУ(СтруктураПараметров)
	...
	Иначе
		...
		КонецЕсли;	
	КонецЕсли;
	СтруктураПараметров.Элементы.РасчетЧисленностиКакВ1ПВ.Видимость  = СтруктураПараметров.ЗарплатаКадрыРасширенная;
...
Процедура ДействияПриЗакрытии()
	...
	ВладелецФормы.СтруктураРеквизитовФормы.РасчетЧисленностиКакВ1ПВ = РасчетЧисленностиКакВ1ПВ;
	...
	ОбщегоНазначенияВызовСервера.ХранилищеОбщихНастроекСохранить("РегламентированнаяОтчетность", "РегламентированнаяОтчетность_НДФЛЕСВ_РасчетЧисленностиКакВ1ПВ", 	  РасчетЧисленностиКакВ1ПВ);
