...
Процедура Заполнить(ПараметрыЗаполненияЗвит1С)
	...
	Для СчетчикМесяцев = 0 по КолМесяцевВПериоде-1 Цикл 
		...
		Если ЗарплатаКадрыРасширенная Тогда
			...
			МассивВидыВремениОтпуска = Новый Массив();
			МассивВидыВремениОтпуска.Добавить(Справочники.ВидыИспользованияРабочегоВремени.ОтпускНаДетей);
			МассивВидыВремениОтпуска.Добавить(Справочники.ВидыИспользованияРабочегоВремени.ОтпускНаОбучение);
			МассивВидыВремениОтпуска.Добавить(Справочники.ВидыИспользованияРабочегоВремени.ДополнительныйОтпуск);
			МассивВидыВремениОтпуска.Добавить(Справочники.ВидыИспользованияРабочегоВремени.ОсновнойОтпуск);
			Запрос.УстановитьПараметр("ВидыВремениОтпуска", МассивВидыВремениОтпуска);
			...
			|	ИЛИ ДанныеУчетаВремениПоСостояниям.ВидУчетаВремени В (&ВидыВремениОтпуска)
			|СГРУППИРОВАТЬ ПО
