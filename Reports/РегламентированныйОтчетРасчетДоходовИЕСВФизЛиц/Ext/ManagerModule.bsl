...
Функция ТаблицаФормОтчета() Экспорт
	...
	НоваяФорма.ОписаниеОтчета     = НСтр("ru='Утвержден Приказом Минфина от 13.01.2015 N 4 (в редакции Приказа Минфина №  от  )';uk='Затверджено Наказом Мінфіну від 13.01.2015 N 4 (у редакції Наказу Мінфіна №  від  )'");
