...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета  = КонецДня(Параметры.мДатаКонцаПериодаОтчета);
	СтруктураРеквизитовФормы.мДатаНачалаПериодаОтчета = НачалоДня(Параметры.мДатаНачалаПериодаОтчета);
