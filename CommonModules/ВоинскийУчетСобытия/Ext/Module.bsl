...
Функция ВоеннообязанныйРаботник(ФизическоеЛицо, Период)
	...
	Запрос.Текст = "ВЫБРАТЬ
				   ...
				   |				И ОтношениеКВоинскойОбязанности В (ЗНАЧЕНИЕ(Перечисление.ОтношениеКВоинскойОбязанности.Призывник), ЗНАЧЕНИЕ(Перечисление.ОтношениеКВоинскойОбязанности.Военнообязанный), ЗНАЧЕНИЕ(Перечисление.ОтношениеКВоинскойОбязанности.Резервист))
