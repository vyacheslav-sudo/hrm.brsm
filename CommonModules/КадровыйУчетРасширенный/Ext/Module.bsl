...
Функция НеобходимыСведенияОВоинскомУчетеФизическихЛиц(Знач ИмяПоля)
	...
	Возврат ИмяПоля = ВРег("ВоинскийУчетПериодРегистрации")
		...
		Или ИмяПоля = ВРег("ВоинскийУчетДатаВыдачиМобпредписания") 
		Или ИмяПоля = ВРег("ВоинскийУчетСрокОтсрочки")
		Или ИмяПоля = ВРег("ВоинскийУчетОснованиеОтсрочки")
		Или ИмяПоля = ВРег("ВоинскийУчетПроходитВоеннуюСлужбу") 
		Или ИмяПоля = ВРег("ВоинскийУчетАдресУчета")
...
Функция ПутьКДаннымСведенийОВоинскомУчетеФизическихЛиц(Знач ИмяПоля)
	...
	ИначеЕсли ИмяПоля = ВРег("ВоинскийУчетДатаВыдачиМобпредписания") Тогда
		ПутьКДанным = "	ВоинскийУчет.ДатаВыдачиМобпредписания"; 
	ИначеЕсли ИмяПоля = ВРег("ВоинскийУчетСрокОтсрочки") Тогда
		ПутьКДанным = "	ВоинскийУчет.СрокОтсрочки";   
	ИначеЕсли ИмяПоля = ВРег("ВоинскийУчетОснованиеОтсрочки") Тогда
		ПутьКДанным = "	ВоинскийУчет.ОснованиеОтсрочки";
	ИначеЕсли ИмяПоля = ВРег("ВоинскийУчетПроходитВоеннуюСлужбу") Тогда
		ПутьКДанным = "	ВоинскийУчет.ПроходитВоеннуюСлужбу";
	ИначеЕсли ИмяПоля = ВРег("ВоинскийУчетАдресУчета") Тогда
		ПутьКДанным = "	ВоинскийУчет.АдресУчета";
    КонецЕсли;
