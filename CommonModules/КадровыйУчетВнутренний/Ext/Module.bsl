...
Функция СреднесписочнаяЧисленностьРаботающих(Организация, НачалоПериода, КонецПериода, ИсключатьПериодыПоПравилам1ПВ = Истина) Экспорт 
	...
	Возврат КадровыйУчетРасширенный.СреднесписочнаяЧисленностьРаботающих(Организация, НачалоПериода, КонецПериода, ИсключатьПериодыПоПравилам1ПВ)	
...
//			- ПриказОбУвольненииСтатьяКЗОТ	- Строка
//
