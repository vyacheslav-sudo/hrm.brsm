...
Процедура ЗагрузитьФайлыИзБанка(ПараметрыЗагрузки) Экспорт
	...
	ТекстСообщения = НСтр("ru='Для загрузки файлов рекомендуется установить расширение для веб-клиента BAF.';uk='Для завантаження файлів рекомендується встановити розширення для вебклієнта BAF.'");
...
Процедура СохранитьФайлыДляОбменаСБанком(ПолучаемыеФайлы, ПараметрыСохранения = Неопределено) Экспорт
	...
	ТекстСообщения = НСтр("ru='Для сохранения файлов рекомендуется установить расширение для веб-клиента BAF.';uk='Для збереження файлів рекомендується встановити розширення для вебклієнта BAF.'");
