...
Функция РассчитатьУдержанныеНалоги(Регистратор, Организация, ДатаОперации, МенеджерТаблиц, ПериодРегистрации = Неопределено) Экспорт
	...
	Если ПараметрыПолученияЗарплатыКВыплате.СпособПолучения = Перечисления.СпособыПолученияЗарплатыКВыплате.ОкончательныйРасчет Тогда		
		...
		|		ПО (СписокСотрудников.ФизическоеЛицо = РасчетыСФондамиПоСтраховымВзносам.ФизическоеЛицо ИЛИ РасчетыСФондамиПоСтраховымВзносам.ФизическоеЛицо = ЗНАЧЕНИЕ(Справочник.ФизическиеЛица.ПустаяСсылка))		
