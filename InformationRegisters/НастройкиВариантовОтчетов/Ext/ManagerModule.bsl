...
Процедура ОповеститьПользователейВариантаОтчета(Записи) Экспорт 
	...
	Исключение
		...
		ЗаписьЖурналаРегистрации(
			НСтр("ru='Варианты отчетов.Оповещение о предоставлении доступа к варианту отчета';uk='Варіанти отчетов.Сповіщення про надання доступу до варіанту звіту'",КодОсновногоЯзыка),
