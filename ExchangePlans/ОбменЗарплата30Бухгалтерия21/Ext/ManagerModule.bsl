...
Процедура ПриПолученииОписанияВариантаНастройки(ОписаниеВарианта, ИдентификаторНастройки, ПараметрыКонтекста) Экспорт
	...
	ПодробнаяИнформацияПоОбмену = "ПланОбмена.ОбменЗарплата30Бухгалтерия21.Форма.ПодробнаяИнформация";
	
	ОписаниеВарианта.ИмяФайлаНастроекДляПриемника = НСтр("ru = 'Настройки обмена ЗУП - БП'; uk = 'Налаштування обміну ЗУП - БП'");
	...
	ОписаниеВарианта.КраткаяИнформацияПоОбмену = НСтр("ru = 'Обмен с BAS Бухгалтерией, ред. 2.1'; uk = 'Обмін із BAS Бухгалтерією, ред. 2.1'");
	...
	ЗаголовокКоманды   = НСтр("ru = 'BAS Бухгалтерия, ред. 2.1'; uk = 'BAS Бухгалтерія, ред. 2.1'");
	ЗаголовокПомощника = НСтр("ru = 'Синхронизация с BAS Бухгалтерией, ред. 2.1 (настройка)'; uk = 'Синхронізація із BAS Бухгалтерією, ред. 2.1 (настройка)'");
	ЗаголовокУзла      = НСтр("ru='Синхронизация с BAS Бухгалтерией, ред. 2.1");
	...
	ОписаниеВарианта.ИмяФормыПомощникаНастройкиСинхронизацииДанных =
		"ПланОбмена.ОбменЗарплата30Бухгалтерия21.Форма.ПомощникНастройкиСинхронизацииДанных";
