...
Процедура УстановитьДоступностьЭлементаКатегорияЕСВ()
	...
	Если ЗначениеЗаполнено(Объект.ВидАвторскогоДоговора) Тогда
		Элементы.КатегорияЕСВ.Доступность = ?(Объект.ВидАвторскогоДоговора.ВидЕСВ = Перечисления.ВидыЕСВ.НеУчитывается, Ложь , Истина);
	Иначе 	
