...
Функция ДанныеПервичногоБольничногоЛиста(ПервичныйБольничныйЛист, ИсключаемыеДокументы = Неопределено) Экспорт
	...
	|	БольничныйЛист.РучнаяКорректировкаСреднегоЗаработка,
	|	ВЫБОР
	|		КОГДА БольничныйЛист.РучнаяКорректировкаСреднегоЗаработка
...
Функция ДанныеДляПечатиРасчетаСтажа(МассивСсылок)
	...
	Для Каждого Док Из МассивСсылок Цикл
		...
		ДанныеОСтажеСотрудника.Вставить("НомерДокумента", Док.Номер);
