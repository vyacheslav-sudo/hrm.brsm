		...
		Пока ВыборкаПоСтрокам.НайтиСледующий(СтруктураПоиска) Цикл 
			...
			Пока ВыборкаПоДатам.Следующий() Цикл 
				...
				Пока ВыборкаПоСотрудникам.Следующий() Цикл 
					...
					ДанныеСтроки.Вставить("ФИО", ФизическиеЛицаКлиентСервер.ИмяФамилияВФорматеДСТУ(ВыборкаПоСотрудникам));
...
Функция ДанныеДляПечатиПриказаОРаботеВВыходнойИПраздничныйДень(МассивОбъектов)
	...
	КадровыйУчет.СоздатьВТКадровыеДанныеСотрудников(ОписательВременныхТаблиц, Истина, "ФамилияИО,ИОФамилия,Должность, Фамилия, Имя, Отчество");
...
Функция ПечатнаяФормаГрафикРаботыВВыходнойИПраздничныйДень(МассивОбъектов, ОбъектыПечати, ПараметрыВывода)
	...
	Пока ВыборкаПоДокументам.Следующий() Цикл  
		...
		ОбластьПодвал.Параметры.ФИООтветственного = ФизическиеЛицаклиентСервер.ИмяФамилияВФорматеДСТУ(ОбластьПодвал.Параметры.ФИООтветственного);
		ТабДокумент.Вывести(ОбластьПодвал);
