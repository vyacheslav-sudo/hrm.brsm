...
Функция РеквизитыДляПроведенияПустаяСтруктура()
	...
	РеквизитыДляПроведенияПустаяСтруктура = Новый Структура("Ссылка, Организация, ПериодРегистрации, ПерерасчетВыполнен, Дата, ОтсутствиеВТечениеЧастиСмены, Сотрудник, 
		| СостояниеСотрудника, ДатаНачала, ДатаОкончания, ДатаОтсутствия, ВидОтсутствия, ВидВремениЗамещаемый, ЧасовОтсутствия, РаспределениеПоТерриториямУсловиямТруда, ОсвобождатьСтавку");	
