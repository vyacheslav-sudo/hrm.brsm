...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	УправлениеШтатнымРасписаниемФормы.УстановитьСтрокуТекущейПозиции(
		ЭтаФорма, "ПоказателиПозиций", "ПокзателиПозиций", "ПозицияШтатногоРасписания");
...
Функция КлючевыеРеквизитыЗаполненияФормыОписаниеКлючевыхРеквизитов() Экспорт
	...
	Массив.Добавить(Новый Структура("ЭлементФормы, Представление", "МесяцСтрокой", 		НСтр("ru='месяца начисления';uk='місяця нарахування'")));
	Возврат Массив
КонецФункции
