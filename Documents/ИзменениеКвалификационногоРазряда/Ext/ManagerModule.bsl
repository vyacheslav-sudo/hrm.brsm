...
Процедура Печать(МассивОбъектов, ПараметрыПечати, КоллекцияПечатныхФорм, ОбъектыПечати, ПараметрыВывода) Экспорт
	...
	Если УправлениеПечатью.НужноПечататьМакет(КоллекцияПечатныхФорм, "ПФ_MXL_ПриказОПрисвоенииРазряда") Тогда
		УправлениеПечатью.ВывестиТабличныйДокументВКоллекцию(
						...
						"ПФ_MXL_ПриказОПрисвоенииРазряда", НСтр("ru='Приказ о присвоении разряда';uk='Наказ про присвоєння розряду'"), 
						ПечатнаяФормаПриказаОПрисвоенииРазряда(МассивОбъектов, ОбъектыПечати, ПараметрыВывода.КодЯзыкаДляМногоязычныхПечатныхФорм), ,
						"Документ.РаботаСверхурочно.ПФ_MXL_ПриказОПрисвоенииРазряда",,Истина);
	КонецЕсли;
	
КонецПроцедуры

Функция ПечатнаяФормаПриказаОПрисвоенииРазряда(МассивОбъектов, ОбъектыПечати, КодЯзыка)
	...
	Макет = УправлениеПечатью.МакетПечатнойФормы("Документ.ИзменениеКвалификационногоРазряда.ПФ_MXL_ПриказОПрисвоенииРазряда",КодЯзыка);
	...
	Пока ВыборкаПоДокументам.Следующий() Цикл  
		...
		Параметры.ДатаИзменения = Формат(Параметры.ДатаИзменения,"Л="+КодЯзыка+";" "ДЛФ=ДД");
		...
		ОбластьПодвал.Параметры.ФИО = ФизическиеЛицаклиентСервер.ИмяФамилияВФорматеДСТУ(ВыборкаПоДокументам.ФИОПолные);
		ОбластьПодвал.Параметры.РуководительРасшифровкаПодписи = ФизическиеЛицаклиентСервер.ИмяФамилияВФорматеДСТУ(ВыборкаПоДокументам.РуководительРасшифровкаПодписи);
		
		ОбластьШапка.Параметры.НазваниеОрганизации = ВРег(Параметры.НазваниеОрганизации);
...
Функция ДанныеДляПечатиПриказаОПрисвоенииРазряда(МассивОбъектов)
	...
	|	ФИООтветственныхЛиц.ФИОПолные КАК РуководительРасшифровкаПодписи
	|ИЗ
